...
const TASK_TYPE = 'field_visit';

@Controller('v1/api/organizations/:organizationId/field-visits')
...
export class FieldVisitsController {
  ...
  async findAll(
    ...
    @Query() query: QueryFieldVisitDto,
  ...
  async create(
    ...
    return SuccessHelper.createSuccessResponse(data, 'Visit created');
  }
  ...
  async update(
    ...
    return SuccessHelper.createSuccessResponse(data, 'Visit updated');
  }
  ...
  async remove(
    ...
    return SuccessHelper.createSuccessResponse(null, 'Visit removed');
  }
