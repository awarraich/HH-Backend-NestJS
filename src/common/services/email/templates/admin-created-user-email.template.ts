export class AdminCreatedUserEmailTemplate {
  static generate(
...
<head>
  ...
  <title>Welcome to homehealth.ai - Your Account Has Been Created</title>
  <!--[if mso]>
  <style type="text/css">
...
<body style="margin: 0; padding: 0; background-color: #f9fafb; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">
  ...
  <div style="display: none; max-height: 0; overflow: hidden;">
    Your homehealth.ai account has been created. Please verify your email to get started.
  </div>
  ...
  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color: #f9fafb; padding: 60px 20px;">
                ...
                <tr>
                  <td style="padding-bottom: 20px;">
                    <p style="margin: 0; color: #4b5563; font-size: 16px; line-height: 1.7;">
                      Your account has been created on <strong style="color: #111827;">homehealth.ai</strong>. Below are your login credentials:
                    </p>
                  </td>
                </tr>
                            ...
                            <tr>
                              ...
                              <td valign="top">
                                ...
                                <p style="margin: 0; color: #b91c1c; font-size: 14px; line-height: 1.6;">
                                  Please keep your login credentials secure. After verifying your email, you can log in using the credentials above. We recommend changing your password after your first login for added security.
                                </p>
                              </td>
                            </tr>
                          </table>
                      ...
                      <tr>
                        <td style="padding: 20px;">
                          ...
                          <p style="margin: 0 0 16px 0; color: #6b7280; font-size: 14px; line-height: 1.7;">
                            After verifying your email, you can log in at:
                          </p>
    ...
    const text = `
Welcome to homehealth.ai - Your Account Has Been Created

Hello ${userName},

Your account has been created on homehealth.ai. Below are your login credentials:
...
© 2026 homehealth.ai. All rights reserved.
    ...
    return {
      subject: 'Welcome to homehealth.ai - Your Account Has Been Created',
      html: html.trim(),
      text: text.trim(),
    };
  }
