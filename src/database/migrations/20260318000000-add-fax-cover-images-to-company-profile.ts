...
/**
 * Add fax and cover_images to company profile.
 * Safe for DBs that already have these (ADD COLUMN IF NOT EXISTS).
 * Run this on production if the table was created before these columns were in the initial migration.
 */
