...
export class CreateStaffManagementTables20260219000001 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.createIndex(
      'organization_staff',
      new TableIndex({
        name: 'idx_organization_staff_organization_id',
        columnNames: ['organization_id'],
      }),
    );
    await queryRunner.createIndex(
    ...
    await queryRunner.createIndex(
      'organization_staff',
      new TableIndex({
        name: 'idx_organization_staff_staff_role_id',
        columnNames: ['staff_role_id'],
      }),
    );
    await queryRunner.createIndex(
      'organization_staff',
      new TableIndex({
        name: 'idx_organization_staff_org_status',
    ...
    await queryRunner.createIndex(
      'organization_staff_role_permissions',
      new TableIndex({
        name: 'idx_org_staff_role_permissions_organization_id',
        columnNames: ['organization_id'],
      }),
    );
    await queryRunner.createIndex(
      'organization_staff_role_permissions',
      new TableIndex({
        name: 'idx_org_staff_role_permissions_staff_role_id',
        columnNames: ['staff_role_id'],
      }),
    );
    await queryRunner.createIndex(
